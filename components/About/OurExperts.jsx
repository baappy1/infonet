...
const DEFAULT_MEMBERS = [
  { id: 1, name: "Emma L.", role: "Head of IT Operations", image: "/assets/about/emma-2.png", department: "IT Operations" },
  { id: 2, name: "Oliver K.", role: "Director of Infrastructure", image: "/assets/about/oliver-2.png", department: "Infrastructure" },
  { id: 3, name: "Sophia M.", role: "Vice President of Technology", image: "/assets/about/sophia-2.png", department: "Technology" },
  { id: 4, name: "Liam J.", role: "Chief Technology Officer", image: "/assets/about/liam-2.png", department: "Leadership" },
  { id: 5, name: "Noah R.", role: "Lead Software Architect", image: "/assets/about/emma-2.png", department: "Engineering" },
];

const OurExperts = ({
  topTitle = "[ Meet Our Experts ]",
  title = "Our Diverse Team Works Across Departments.",
