        ...
        <div className="container lg:pr-0 lg:pl-0 pr-5 pl-5">
          <div className="flex flex-wrap lg:flex-row flex-col justify-between">
            <div className="w-full lg:w-[40.7%] sm:mb-0 mb-10">
              <div className="top-title mb-5">[ what includes ]</div>
              <h2 className="heading-h2 mb-5">
                What We Set Up for Your Success
              </h2>
              <p className="paragraph-text mb-5">
                Get a complete, end-to-end service that ensures your systems are
                installed, configured, and running flawlessly from day one.We
                handle the technical work so you can focus on running your
              ...
              <ul className="w-full">
                {includeItems.map((item, index) => (
                  <IncludeCard
                    ...
                    index={index} // if you're using staggered animations
                  />
                ))}
