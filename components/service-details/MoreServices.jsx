        ...
        <div className="container lg:pr-[0] lg:pl-[0] pr-[20px] pl-[20px]">
          ...
          <div className="flex flex-col">
            <div className="w-full  mb-20">
              <div className="top-title mb-5">[ More services ]</div>
              ...
              <p className="paragraph-text mt-5 max-w-162.25">
                From hardware sourcing to hands-on training, our services are
                designed to help your operations run efficiently and reliably.
              </p>
            </div>
