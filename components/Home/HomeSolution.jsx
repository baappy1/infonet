          ...
          <div className="w-full lg:w-[40.7%]">
            ...
            >
              {accordionItems.map((item, idx) => (
                ...
                >
                  <AccordionTrigger className="pt-5 pb-6 flex justify-between items-center leading-4.5 lg:leading-5.5! font-normal! uppercase text-[14px] lg:text-[16px] hover:no-underline">
